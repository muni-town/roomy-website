<section class="section-wrapper mb-20 flex flex-col-reverse gap-10 lg:relative lg:h-[560px]">
	<figure
		class="left-[-10%] flex items-center justify-center lg:absolute lg:h-[540px] lg:w-[540px]"
	>
